    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          vector<double> mpc_y_vals{result[2], result[3], result[4], result[5], result[6], result[7]};
          vector<double> mpc_x_vals{result[8], result[9], result[10], result[11], result[12], result[13]};
          ...
          //cast vectorXd to vector
          vector<double> next_x_vals(e_x.data(), e_x.data() + e_x.rows() * e_x.cols());
          vector<double> next_y_vals(e_y.data(), e_y.data() + e_y.rows() * e_y.cols());
